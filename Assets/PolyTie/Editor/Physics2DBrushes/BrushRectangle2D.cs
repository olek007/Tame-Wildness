...
public class BrushRectangle2D : Editor 
{
    ...
    [MenuItem("GameObject/Create 2D Objects/Rectangles/Rectangle")]
    ...
    [MenuItem("GameObject/Create 2D Objects/Rectangles/Static")]
    public static void CreateStaticRectangle()
    {
        var go = new GameObject("StaticRectangle2D");
        Undo.RegisterCreatedObjectUndo(go, "Created Rectangle2D");
        var collider = go.AddComponent<BoxCollider2D>();
        collider.size = Vector2.zero;
    ...
    [MenuItem("GameObject/Create 2D Objects/Rectangles/Trigger")]
    public static void CreateTriggerRectangle()
    {
        var go = new GameObject("TriggerRectangle2D");
        Undo.RegisterCreatedObjectUndo(go, "Created Rectangle2D");
        var collider = go.AddComponent<BoxCollider2D>();
        collider.size = Vector2.zero;
    ...
    [MenuItem("GameObject/Create 2D Objects/Rectangles/Dynamic")]
    public static void CreateDynamicRectangle()
    {
        var go = new GameObject("DynamicRectangle2D");
        Undo.RegisterCreatedObjectUndo(go, "Created Rectangle2D");
        var collider = go.AddComponent<BoxCollider2D>();
        collider.size = Vector2.zero;
    ...
    [MenuItem("GameObject/Create 2D Objects/Rectangles/Moving")]
    public static void CreateMovingRectangle()
    {
        var go = new GameObject("MovingRectangle2D");
        Undo.RegisterCreatedObjectUndo(go, "Created Rectangle2D");
        var collider = go.AddComponent<BoxCollider2D>();
        collider.size = Vector2.zero;
    ...
    [MenuItem("GameObject/Create 2D Objects/Rectangles/Killing Zone")]
