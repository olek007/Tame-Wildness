...
public class BrushEdge2D : Editor
{
    ...
    [MenuItem("GameObject/Create 2D Objects/Edges/Edge")]
    ...
    [MenuItem("GameObject/Create 2D Objects/Edges/Static")]
    public static void CreateStaticEdge()
    {
        var go = new GameObject("StaticEdge2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Edge2D");
        var collider = go.AddComponent<EdgeCollider2D>();
        collider.points = new Vector2[] { Vector2.zero, Vector2.zero };
    ...
    [MenuItem("GameObject/Create 2D Objects/Edges/Trigger")]
    public static void CreateTriggerEdge()
    {
        var go = new GameObject("TriggerEdge2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Edge2D");
        var collider = go.AddComponent<EdgeCollider2D>();
        collider.points = new Vector2[] { Vector2.zero, Vector2.zero };
    ...
    [MenuItem("GameObject/Create 2D Objects/Edges/Moving")]
    public static void CreateMovingEdge()
    {
        var go = new GameObject("MovingEdge2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Edge2D");
        var collider = go.AddComponent<EdgeCollider2D>();
        collider.points = new Vector2[] { Vector2.zero, Vector2.zero };
    ...
    [MenuItem("GameObject/Create 2D Objects/Edges/Killing Zone")]
