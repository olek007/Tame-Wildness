...
public class BrushPolygon2D : Editor 
{
    ...
    [MenuItem("GameObject/Create 2D Objects/Polygons/Static &s")]
    public static void CreateStaticPolygon()
    {
        var go = new GameObject("StaticPolygon2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Polygon2D");
        var collider = go.AddComponent<PolygonCollider2D>();
        collider.points = null;
    ...
    [MenuItem("GameObject/Create 2D Objects/Polygons/Trigger &t")]
    public static void CreateTriggerPolygon()
    {
        var go = new GameObject("TriggerPolygon2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Polygon2D");
        var collider = go.AddComponent<PolygonCollider2D>();
        collider.points = null;
    ...
    [MenuItem("GameObject/Create 2D Objects/Polygons/Dynamic &d")]
    public static void CreateDynamicPolygon()
    {
        var go = new GameObject("DynamicPolygon2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Polygon2D");
        var collider = go.AddComponent<PolygonCollider2D>();
        collider.points = null;
    ...
    [MenuItem("GameObject/Create 2D Objects/Polygons/Moving &m")]
    public static void CreateMovingPolygon()
    {
        var go = new GameObject("MovingPolygon2D");
        Undo.RegisterCreatedObjectUndo(go, "Create Polygon2D");
        var collider = go.AddComponent<PolygonCollider2D>();
        collider.points = null;
    ...
    [MenuItem("GameObject/Create 2D Objects/Polygons/Killing Zone &k")]
